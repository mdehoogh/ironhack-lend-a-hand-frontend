...
function ChatRoomPageUsingFormik() {
  ...
  // MDH@03FEB2020: what's going on?????
  const getMessage = (values)=>{
    console.log("Values",values);
    return(values&&values.message);
  };
  return (
...
export default ChatRoomPageUsingFormik;